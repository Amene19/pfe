...
const getAllCompanies = async () => {
  ...
  const getNumbers = async () => {
    try {
        const response = await axios.get(`http://localhost:3000/api/dashboard/admin/manageMissions/total`, { withCredentials: true });
  ...
  const isModeratorPath = location.pathname === '/admin';
