...
const getAllCompanies = async () => {
  ...
  const getNumbers = async () => {
    try {
        const response = await axios.get(`http://localhost:3000/api/dashboard/technician/manageMissions/total`, { withCredentials: true });
    ...
    const getAllMissions = async () => {
        try {
            const response = await axios.get(`http://localhost:3000/api/dashboard/technician/manageMissions/userMissions/${id}`, { withCredentials: true });
  ...
  const isModeratorPath = location.pathname === '/technician';
